...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style23">Secure and Efficient Attribute-Based Access Control <br />
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <table width="805" border="2" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="60" height="31" bgcolor="#FF0000"><div align="center" class="style24"> ID </div></td>
