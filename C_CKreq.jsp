...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><span class="style23">Secure and Efficient Attribute-Based Access Control <br />
        for Multiauthority Hybrid Cloud Storage</span></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Content Key User Requests </span>!!!</h2>
          <p>&nbsp;</p>
          <table width="618" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="66" height="30" bgcolor="#FF0000"><div align="center" class="style24"> ID </div></td>
              ...
              <td width="123" bgcolor="#FF0000"><div align="center" class="style24">Content Key </div></td>
		    </tr> 
              <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div class="style23">
                  <div align="center"><a href="C_CKreq1.jsp?usid=<%=i%>&amp;fname=<%=s4%>">Give Permission</a></div>
              </div></td>
              <%
